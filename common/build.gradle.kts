...
tasks {
    ...
    withType<DokkaTask>().configureEach {
        dokkaSourceSets {
            named("main") {
                moduleName = "Math Common"
                includes.from("dokka.md")

                sourceLink {
                    localDirectory.set(file("src/main/kotlin"))
                    remoteUrl.set(
                        URI("https://github.com/eriksencosta/math-common/tree/trunk/common/src/main/kotlin").toURL()
                    )
...
publishing {
    publications {
        create<MavenPublication>("pom") {
            pom {
                description = "Math conventions to reduce boilerplate code"
                url = "https://github.com/eriksencosta/math-common"
                ...
                scm {
                    url = "git@github.com:eriksencosta/math-common.git"
                    tag = "trunk"
                }

                issueManagement {
                    system = "GitHub"
                    url = "https://github.com/eriksencosta/math-common/issues"
                }

                ciManagement {
                    system = "GitHub Actions"
                    url = "https://github.com/eriksencosta/math-common/actions"
                }
